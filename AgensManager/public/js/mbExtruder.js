	...
	$.mbExtruder= {
		...
		buildMbExtruder: function(options){
			return this.each (function (){
				...
				var c= $("<div/>").addClass("extruder-content").css({overflow:"auto", width:extW});///////////////////////////////////// overflow: "hidden"을 overflow: "auto"로 바꿈.(사이드바 height가 가려져서..ㅠㅠ) 2015-02-23 jakim@bitnine.co.kr
		...
		closeMbExtruder:function(){
			...
			if (opt.position=="top" || opt.position=="bottom"){
				...
				extruder.find('.extruder-content').css({overflow:"auto"});///////////////////////////////////// overflow: "hidden"을 overflow: "auto"로 바꿈.(사이드바 height가 가려져서..ㅠㅠ) 2015-02-23 jakim@bitnine.co.kr
				extruder.find('.extruder-content').animate({ width: 1 }, opt.slideTimer,function(){
					extruder.find('.ext_wrapper').css({width:1});
					extruder.find('.extruder-content').css({overflow:"auto",display:"none"});///////////////////////////////////// overflow: "hidden"을 overflow: "auto"로 바꿈.(사이드바 height가 가려져서..ㅠㅠ) 2015-02-23 jakim@bitnine.co.kr
					if(opt.onExtClose) opt.onExtClose();
				});
			}
		}
